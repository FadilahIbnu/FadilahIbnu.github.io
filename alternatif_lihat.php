...
while ($r2 = mysqli_fetch_array($q2)) {
    ...
    $nama_subkriteria = '';
    $q_opt = mysqli_query($con, "select id_subkriteria from alternatif_kriteria where id_kriteria=" . $id_kriteria . " AND id_alternatif=" . $id);
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<input name="' . $input_name . '" id="' . $input_name . '" class="form-control" readonly type="text" value="' . $nama_subkriteria . '">
		</div>
	</div>';
}
?>
    ...
    <form class="form-horizontal" action="" method="post">
        <div class="box-body">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input name="nama_alternatif" id="nama_alternatif" class="form-control" readonly type="text" value="<?php echo $nama_alternatif; ?>">
                </div>
            </div>
