...
while ($r = mysqli_fetch_array($q)) {
    ...
    $q2 = mysqli_query($con, $q2);
    while ($r2 = mysqli_fetch_array($q2)) {
        $rk = mysqli_fetch_array(mysqli_query($con, "select id_subkriteria from alternatif_kriteria where id_kriteria=" . $r2['id_kriteria'] . " AND id_alternatif=" . $id_alternatif));
